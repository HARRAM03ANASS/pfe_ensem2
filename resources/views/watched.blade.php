...
<div class="container mx-auto px-4 mt-6">
    <h2 class="text-4xl font-extrabold mb-6">You've watched {{count($watched_movies)}} films.</h2>

    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
        @if($watched_movies->isEmpty())
            @if (session('message'))
        ...
        <div class="text-center text-gray-600 mt-8">
            <p class="text-2xl">You haven't watched any movies yet.</p>
        </div>
        @endIf
